...
// Windows printing: path to SumatraPDF.exe (silent CLI printing).
// Found via PATH if left as the bare executable name.
const WIN_PRINT_TOOL = process.env.WIN_PRINT_TOOL || 'SumatraPDF.exe'
